...
def get_model(in_channels, out_channels, kernel_size, stride=(2, 2), padding=(0,0), dilation=(4, 4), groups=1, bias=False, dtype=torch.float16):
...
def set_default_shapes_ranges_and_dtypes():
    ...
    return [in_channels, out_channels, kernel_size_w, kernel_size_h, stride, dilation, batch_size, height, width], \
...
def split_shapes_into_input_and_model_params_shapes(in_channels, out_channels, kernel_size_w, kernel_size_h, stride, dilation, batch_size, height, width):
    return [batch_size, in_channels,  height, width], \
           [in_channels, out_channels, (kernel_size_h, kernel_size_w), (stride, stride), (0, 0), (dilation,dilation)]