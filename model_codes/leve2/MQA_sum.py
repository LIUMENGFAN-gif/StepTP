...
class Model(nn.Module):
    ...
    def __init__(self, n_embd, n_head, batch_size, seq_len, max_seqlen,dtype=torch.float16):
        super().__init__()
...
def get_default_model_params_shapes():
    ...
    n_head = 8
    n_embd = 128
    return [n_embd, n_head,batch_size,seq_len, max_seqlen]
...
def get_model(n_embd, n_head,batch_size,seq_len, max_seqlen, dtype=torch.float16):
    return Model(n_embd, n_head, batch_size,seq_len,max_seqlen, dtype)
...
def set_default_shapes_ranges_and_dtypes():
    ...
    dtypes = [int, int, int,int, int]
    
    return [n_embd, n_head, max_seqlen, batch_size, seq_len], \
           [range_n_embd, range_n_head, range_max_seqlen, range_batch_size, range_seq_len], dtypes

def split_shapes_into_input_and_model_params_shapes(n_embd, n_head, max_seqlen, batch_size, seq_len):
    return [batch_size, seq_len, n_embd], \
           [n_embd, n_head,batch_size, seq_len,max_seqlen]  # attn_pdrop and resid_pdrop are set to 0.0 by default
