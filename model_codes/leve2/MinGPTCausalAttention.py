...
class Model(nn.Module):
    ...
    def __init__(self, n_embd, n_head, max_seqlen,dtype=torch.float16):
        super().__init__()
...
def get_model(n_embd, n_head, max_seqlen, dtype=torch.float16):
    return Model(n_embd, n_head, max_seqlen, dtype)
...
def split_shapes_into_input_and_model_params_shapes(n_embd, n_head, max_seqlen, batch_size, seq_len):
    return [batch_size, seq_len, n_embd], \
           [n_embd, n_head,max_seqlen]  # attn_pdrop and resid_pdrop are set to 0.0 by default
