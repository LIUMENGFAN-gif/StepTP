...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, multiplier_shape, dtype=torch.float16):
        ...
        self.leaky_relu = nn.LeakyReLU().to(dtype)
...
def get_model(in_channels, out_channels, kernel_size, multiplier_shape, dtype=torch.float16):
...
def set_default_shapes_ranges_and_dtypes():
    ...
    return [in_channels, out_channels, kernel_size,
             batch_size, height, width],[range_in_channels, range_out_channels, range_kernel_size,
...
def split_shapes_into_input_and_model_params_shapes(in_channels, out_channels, kernel_size, batch_size, height, width):
    return [batch_size, in_channels, height, width], [in_channels, out_channels, kernel_size, [out_channels, 1, 1]]