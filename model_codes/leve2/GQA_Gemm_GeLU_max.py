...
class Model(nn.Module):
    ...
    def __init__(self, n_embd, n_head,out_features, n_group, batch_size, seq_len, max_seqlen, dtype=torch.float16):
        super().__init__()
...
def get_default_model_params_shapes():
    ...
    n_embd = 128
    out_features = 64
    return [n_embd, n_head, out_features, n_group, batch_size, seq_len, max_seqlen]
...
def get_model(n_embd, n_head, out_features, n_group, batch_size, seq_len, max_seqlen, dtype=torch.float16):
    return Model(n_embd, n_head, out_features, n_group, batch_size, seq_len, max_seqlen, dtype)
...
def set_default_shapes_ranges_and_dtypes():
    ...
    return [n_embd, n_head, out_features, n_group, max_seqlen, batch_size, seq_len], \
           [range_n_embd, range_n_head, range_out_features, range_n_group, range_max_seqlen, range_batch_size, range_seq_len], dtypes

def split_shapes_into_input_and_model_params_shapes(n_embd, n_head, out_features, n_group, max_seqlen, batch_size, seq_len):
    return [batch_size, seq_len, n_embd], [n_embd, n_head, out_features, n_group, batch_size, seq_len, max_seqlen]
