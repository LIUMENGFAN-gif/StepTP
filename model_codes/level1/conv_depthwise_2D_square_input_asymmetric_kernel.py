...
class Model(nn.Module):
    ...
    Args:
        ...
        kernel_size (int): Size of the convolution kernel (height).
    ...
    """
    def __init__(self, in_channels: int, kernel_size: int, stride: int = 1, padding: int = 0, dilation: int = 1, bias: bool = False, dtype: torch.dtype = torch.float16):
...
def get_model(in_channels=3, kernel_size=3, stride=1, padding=0, dilation=1, bias=False, dtype=torch.float16):
    return Model(in_channels, kernel_size, stride, padding, dilation, bias, dtype)
...
def set_default_shapes_ranges_and_dtypes():
    ...
    return [in_channels, kernel_size, stride, padding, dilation, batch_size, height, width], \
           [range_in_channels, range_kernel_size, range_stride, range_padding, range_dilation, range_batch_size, range_height, range_width], \
           dtype

def split_shapes_into_input_and_model_params_shapes(in_channels, kernel_size, stride, padding, dilation, batch_size, height, width):
    return [batch_size, in_channels, height, width], \
