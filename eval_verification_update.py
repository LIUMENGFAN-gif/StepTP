        ...
        if is_built:
            ...
            try:
                ...
                if is_equivalent:
                    ...
                    # initial_time_record(tvm_time_record_dir, idx, tvm_time, torch_time, atol, rtol, MSE, applied_strategy)
...
if __name__ == '__main__':
    ...
    process_one_answer(args.eval_idx, store_dict, model_name, args.transformed_IR, args.cuda, args.error_record_dir)
